...
func (s *service) FetchImagesByViewCategoryCd(param domain.RequestParam) (result []domain.Picture, err error) {
	result, err = s.rep.FetchImagesByViewCategoryCd(param)
	return result, err
}
